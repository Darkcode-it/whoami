...
// Lightweight Lightning background canvas using WebGL fragment shader
    ...
    useEffect(() => {
        ...
        const fragmentShaderSource = `
          ...
          void main(){
            ...
            float glow = pow(0.07 / (dist + 0.0001), 1.0) * uIntensity;
            vec3 col = baseColor * glow;
